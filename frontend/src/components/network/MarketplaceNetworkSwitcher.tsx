...
interface MarketplaceNetworkSwitcherProps {
  selectedNetwork: AvailableNetwork;
  onNetworkChange: (network: AvailableNetwork) => void;
}

/**
 * Standalone network switcher for the marketplace page.
 * Does NOT affect the global NetworkContext or wallet chain — only controls
 * which chain the marketplace queries data from.
 */
export function MarketplaceNetworkSwitcher({ selectedNetwork, onNetworkChange }: MarketplaceNetworkSwitcherProps) {
            ...
            >
              ...
              <div className="flex border-b border-white/10">
                ...
                >
                  ...
                  {activeTab === 'testnet' && (
                    <motion.div
                      layoutId="marketplaceActiveTabIndicator"
