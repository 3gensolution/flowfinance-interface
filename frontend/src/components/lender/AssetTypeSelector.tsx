...
import { Coins, Banknote, AlertCircle, X } from 'lucide-react';
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
        {assetTypes.map((asset) => {
          ...
          const isDisabled = asset.requiresVerification && !isVerified && !isVerificationLoading;
          ...
          return (
            ...
            >
              ...
              {asset.requiresVerification && !isVerified && !isVerificationLoading && (
