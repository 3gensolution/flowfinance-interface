...
export default function FiatOfferDetailPage() {
  ...
  useTransactionFlowEffects({
    ...
    refetchAllowance,
    setStep: setAcceptStep,
    nextStep: 'confirm',
    actionSuccess: acceptSuccess,
    actionSuccessMessage: isOnSupplierChain
      ? 'Fiat lender offer accepted! Your loan is now active.'
      : 'Collateral locked! The relay will activate your loan shortly.',
    onActionSuccess: () => {
    ...
    actionError: acceptError,
    fallbackActionErrorMessage: 'Failed to accept fiat offer',
  ...
  useTransactionFlowEffects({
    actionSuccess: cancelSuccess,
    actionSuccessMessage: 'Fiat lender offer cancelled successfully.',
    onActionSuccess: () => {
    ...
    fallbackActionErrorMessage: 'Failed to cancel fiat offer',
    onActionError: () => {
